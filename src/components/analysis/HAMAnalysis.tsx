...
import { ArrowLeft, Target, TrendingUp, AlertTriangle, MapPin, Calendar, ZoomIn, X, ExternalLink } from 'lucide-react';
import MarkdownRenderer from '@/components/MarkdownRenderer';

const HAMAnalysis = ({ tenderData }: { tenderData: any }) => {
  ...
  const workCategories = {
    'road-composition': `### HAM Road Composition...`,
    'structures-work': `### HAM Structures Work...`,
    'protection-work': `### HAM Protection Work...`,
    'roadside-drainage': `### HAM Roadside Drainage...`,
    'intersections-grade': `### HAM Intersections & Grade Separators...`,
    'road-safety': `### HAM Road Safety and Furniture...`,
    'utilities': `### HAM Utilities and Other Works...`
  };

  const compatibilityAnalysisContent = `### HAM Compatibility Analysis

**Overall Compatibility Score: 77/100** - This HAM tender represents a good match for your organization's capabilities.

### Key Strengths
- Strong HAM project experience
- Excellent maintenance capabilities
- Good long-term project management

### Recommendations
- Focus on life-cycle cost optimization
- Emphasize maintenance excellence`;

  const siteImages = [
    { id: '1', src: 'https://worldtiles1.waze.com/tiles/17/93135/56855.png?highres=true', title: 'HAM Project Site', location: 'Project Area', date: '2024-03-15' }
  ];
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-800 font-medium text-sm">
                  <span className="font-semibold text-teal-700">HAM Project Site:</span> Hybrid Annuity Model project with long-term maintenance responsibilities.
                </p>
              </div>
            </CardContent>
          </Card>

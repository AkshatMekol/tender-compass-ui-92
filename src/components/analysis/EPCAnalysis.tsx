...
const EPCAnalysis = ({ tenderData }: { tenderData: any }) => {
  ...
  const workCategories = {
    'road-composition': `### EPC Road Composition...`,
    'structures-work': `### EPC Structures Work...`,
    'protection-work': `### EPC Protection Work...`,
    'roadside-drainage': `### EPC Roadside Drainage...`,
    'intersections-grade': `### EPC Intersections & Grade Separators...`,
    'road-safety': `### EPC Road Safety and Furniture...`,
    'utilities': `### EPC Utilities and Other Works...`
  };

  const paymentWeightageContent = `### EPC Payment Weightage by Work
  
| Work Category | Weightage |
|---------------|-----------|
| Road Composition | 35% |
| Structures Work | 25% |
| Protection Work | 15% |
| Roadside Drainage | 10% |
| Intersections & Grade Separators | 8% |
| Road Safety and Furniture | 4% |
| Utilities and Other Works | 3% |`;

  const compatibilityAnalysisContent = `### EPC Compatibility Analysis

**Overall Compatibility Score: 77/100** - This EPC tender represents a good match for your organization's capabilities.

### Key Strengths
- Strong EPC project experience
- Excellent technical capabilities
- Good financial capacity

### Recommendations
- Proceed with aggressive bidding
- Focus on project delivery excellence`;

  const siteImages = [
    { id: '1', src: 'https://worldtiles1.waze.com/tiles/17/93135/56855.png?highres=true', title: 'EPC Project Site', location: 'Project Area', date: '2024-03-15' }
  ];
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-800 font-medium text-sm">
                  <span className="font-semibold text-teal-700">EPC Project Site:</span> Engineering, Procurement & Construction project spanning multiple work categories.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <Tabs defaultValue="road-composition">
                <TabsList className="grid w-full grid-cols-3 lg:grid-cols-7 mb-6 bg-gray-100 rounded-xl p-1">
                  <TabsTrigger value="road-composition" className="rounded-lg text-xs">Road Composition</TabsTrigger>
                  <TabsTrigger value="structures-work" className="rounded-lg text-xs">Structures Work</TabsTrigger>
                  <TabsTrigger value="protection-work" className="rounded-lg text-xs">Protection Work</TabsTrigger>
                  <TabsTrigger value="roadside-drainage" className="rounded-lg text-xs">Roadside Drainage</TabsTrigger>
                  <TabsTrigger value="intersections-grade" className="rounded-lg text-xs">Intersections</TabsTrigger>
                  <TabsTrigger value="road-safety" className="rounded-lg text-xs">Road Safety</TabsTrigger>
                  <TabsTrigger value="utilities" className="rounded-lg text-xs">Utilities</TabsTrigger>
                </TabsList>
